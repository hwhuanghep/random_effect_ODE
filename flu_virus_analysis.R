...
#obtain the derivative vector based on given the spline coefficient x, ODE parameter x, and spline matrix bmatrix  
...
#updating ODE variable and parameter for one individual. var.i.c and alpha.c are population level 
#values, missing: missing index for ODE variable, conditioning: conditioning index for ODE variable
#which means if the initial values of ODE variable is provided
...
#model setting for ODE variable
missing=c(0,0,0)
